...
elif year in range(0,1980) and month in ["june" , "June", "july" , "July" , "august" , "August" , "september" , "September"] :
    print("You are a summer baby of the stone age")
elif year in range(0,1980) and month in ["october" , "October" , "november" , "November" , "december" , "December"] :
    print("You are a fall baby of the stone age")
elif year in range(0,1980) and month in [ "january" , "January" , "february" , "February" , "march" , "March"] :
